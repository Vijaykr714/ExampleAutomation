...
class ModifyCustomer{
	...
	static void modifyCustomer() {
		try {
			...
			Thread.sleep(1000);
			wd.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[2]/div[2]/div[1]/div[2]/div[1]/div[3]/div/div[1]")).click();
			Thread.sleep(1000);
...
public class ActiTimeModifyCustomer {
	public static void main(String[] args) {
		ModifyCustomer.addCustomer();
