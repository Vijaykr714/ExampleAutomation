...
class AddTask{
	...
	static void addTask() {
		try {
			createProject();
			wd.findElement(By.xpath("//*[@id='taskListBlock']/div[1]/div[1]/div[3]/div")).click();
			Thread.sleep(1000);
			wd.findElement(By.cssSelector(".item.createNewTask.ellipsis")).click();
			Thread.sleep(3000);
			wd.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("Task1");
			Thread.sleep(500);
			wd.findElement(By.xpath("//*[@id=\'descriptionCell0\']")).click();
			Thread.sleep(2000);
			wd.findElement(By.xpath("//*[@id=\'editDescriptionPopupText\']")).sendKeys("Task Description");
			Thread.sleep(500);
			wd.findElement(By.id("scbutton")).click();
			Thread.sleep(2000);
			wd.findElement(By.xpath("/html/body/div[8]/div/div/div[1]/div[3]/table/tbody/tr[1]/td[3]/div/table/tbody/tr/td[2]/em/button")).click();
			Thread.sleep(2000);
			wd.findElement(By.xpath("/html/body/div[30]/ul/li/div/table/tbody/tr[2]/td/table/tbody/tr[1]/td[5]/a")).click();
			Thread.sleep(500);
			// wd.findElement(By.xpath("/html/body/div[8]/div/div/div[1]/div[3]/table/tbody/tr[1]/td[4]/div/table")).click();
			// Thread.sleep(4000);
			// wd.findElement(By.xpath("/html/body/div[27]/ul/li[2]")).click();
			// Thread.sleep(2000);
			wd.findElement(By.id("createTasksPopup_commitBtn")).click();
			Thread.sleep(3000);
	...
	static void deleteTask() {
		try {
			wd.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[2]/div/div[2]")).click();
			Thread.sleep(2000);
			wd.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[1]/div[2]/div[3]/div/div")).click();
			Thread.sleep(2000);
			wd.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[4]/div/div[3]")).click();
			Thread.sleep(1000);
			wd.findElement(By.id("taskPanel_deleteConfirm_submitBtn")).click();
			Thread.sleep(3000);
			deleteProject();
		}catch (Exception e) {
			e.printStackTrace();
	...
	static void deleteProject() {
		try {
			...
			Thread.sleep(500);
			wd.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(2000);
